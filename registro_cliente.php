<?php 
	...
	if(!empty($_POST)){
		...
		if(empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion'])){
			...
			$alert='<p class="msg_error">Todos los campos se deben llenar obligatoriamente.</p>';
		}else{
			...
			$alert='<p class="msg_error">RFC ya existe.</p>';
				...
				if($query_insert){
					...
					$alert='<p class="msg_save">El cliente guardado correctamente.</p>';

				}else{

					$alert='<p class="msg_error">Error cliente no guardado.</p>';
	...
	<section id="container">
		...
		<div class="form_register">
			...
			<form action="" method="post">
				...
				<input type="number" name="nit" id="nit" placeholder="Número de RFC">
